...
import { getWeapons, getHelmets, getChestpieces, getGloves, getCoats, getLeggings, getCigars, getConsumables } from '../api'; // Asegúrate de tener las funciones de API correspondientes
  ...
  return (
    <div className="item-categories">
      ...
      <ul>
        ...
        <li onClick={() => handleClick('cigars')}>7. Todas las Ciguas</li>
